...
<div class="main-content bg-primary">
        <section class="section">
          <div class="section-header">
            <h1><marquee>EDIT SISWA</marquee></h1>
                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-lg-4 col-md-6">
                             <select name="id_kelas">
                                    ...
                                    <?php
                                    $idbarangyangdipilih=$data['id_siswa']; 
                                    // jalankan query untuk menampilkan semua data diurutkan berdasarkan id
                                    $query = "SELECT * FROM siswa ORDER BY nama_siwa ASC";
                                    $result = mysqli_query($koneksi, $query);
                                    ...
                                    {
                                    ?>
                                  <option value="<?php echo $row['id_siswa']; ?>" <?php if($row['id_siswa']=="$idbarangyangdipilih"){?> selected="selected" <?php } ?>><?php echo $row['nama_kelas']; ?></option>
                               <?php
                          ...
                          <div class="col-lg-4 col-md-6">
                             <select name="tahun" disabled="">
                                    ...
                                    {
                                    ?> 
                                  <option value="<?php echo $row['id_siswa']; ?>" <?php if($row['id_siswa']=="$idbarangyangdipilih"){?> selected="selected" <?php } ?>><?php echo $row['tahun']; ?></option>
                               <?php
                                      $no++; //untuk nomor urut terus bertambah 1
                                    }
                                    ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">RUBAH SISWA<i class="fas fa-arrow-right"></i></button>
                          </div>
                        </div>
                      </div>
                    </form>
